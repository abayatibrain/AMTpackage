# ============================================================
# AutoMorphoTrack â Temporal Dynamics Analysis
# ============================================================
...
def analyze_temporal_dynamics(
    ...
    if not records:
        print("No temporal data found â skipping temporal dynamics analysis.")
        return
    ...
    print(f"Temporal dynamics analysis complete â results saved in {out.resolve()}")
